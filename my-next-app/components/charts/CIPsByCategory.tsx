...
interface Props { records: { category: string }[]; }

export default function CIPsByCategory({ records }: Props) {
  ...
  return (
    <div className="bg-gray-900 border border-gray-800 rounded-2xl p-5">
      <h3 className="text-sm font-semibold text-white mb-1">CIPs by Category</h3>

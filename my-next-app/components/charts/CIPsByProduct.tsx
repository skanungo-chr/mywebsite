...
interface Props { records: { product: string }[]; }

export default function CIPsByProduct({ records }: Props) {
  ...
  return (
    <div className="bg-gray-900 border border-gray-800 rounded-2xl p-5">
      <h3 className="text-sm font-semibold text-white mb-1">CIPs by Product</h3>
      ...
      <ResponsiveContainer width="100%" height={240}>
        <BarChart data={data} margin={{ top: 16, right: 16, left: 0, bottom: 60 }}>
          ...
          <Bar dataKey="value" radius={[4, 4, 0, 0]} maxBarSize={60}>
            {data.map((_, i) => <Cell key={i} fill="#60a5fa" fillOpacity={0.85} />)}
